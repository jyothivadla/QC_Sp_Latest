	...
	public static void internaltf(String SSN,String AppURL) throws InterruptedException{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr[2]/td/table[1]/tbody/tr[1]/td[2]/select")).sendKeys("Drawer 1 to safe");;	
