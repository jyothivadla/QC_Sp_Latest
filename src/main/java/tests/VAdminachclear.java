...
public class VAdminachclear extends QCStore{


	public static void achclear(WebDriver driver,String SSN,String AppURL)
	{
	try{
		...
		//ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+Vprop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
			...
			{		
		       ...
		       // String CaseNo = TestData.getCellData(sheetName,"StoreID",row);
				...
				test.log(LogStatus.INFO,"Admin Login "+ AdminURL);
	...
	test.log(LogStatus.PASS, "ACH link");

	driver.findElement(By.linkText("LOC")).click();
	test.log(LogStatus.PASS, "LOC link");

	driver.findElement(By.linkText("ACH Clear")).click();
	test.log(LogStatus.PASS, "ACH Clear");
	driver.switchTo().defaultContent();
