									 ...
									 driver.switchTo().defaultContent();
									    ...
									    Thread.sleep(5000);
									    	 ...
									    	 driver.findElement(By.xpath("/html/body/table/tbody/tr[1]/td[1]/table[2]/tbody/tr[2]/td/table/tbody/tr[2]/td[8]/input")).click();
											    ...
											    driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[5]/td[9]/input[1]")).click();
											    test.log(LogStatus.PASS, "Clicked on Go button under ULOC Loans section");
