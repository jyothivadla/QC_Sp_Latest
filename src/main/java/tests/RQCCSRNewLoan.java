	...
	public static void newLoan(String SSN,String AppURL) throws Exception
	{
		...
		{	
			...
			{		
			    ...
			    test.log(LogStatus.PASS, "collateralType is entered: "+ESign_CollateralType);
                Thread.sleep(5000);
...
*/
	...
	test.log(LogStatus.PASS, "Clicked on loan button");
		...
		if (ESign_CollateralType.equals("ACH"))
		{
			...
			//test.log(LogStatus.PASS, "click on Finish Loan button ");
			//driver.findElement(By.name("OKBut")).click();/html/body/form/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr[2]/td/input[1]
			...
			test.log(LogStatus.PASS, "click on New loan finished button ");
			//Thread.sleep(3000);
