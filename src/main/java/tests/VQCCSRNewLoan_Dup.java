...
public class VQCCSRNewLoan_Dup extends QCStore{
...
public static void LOC() throws InterruptedException
{
	...
	test.log(LogStatus.PASS, "Clicked on loan button");
		...
		{
			driver.findElement(By.xpath("//*[@id='errorMessage']/form[1]/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[2]/td[2]/input")).sendKeys(ESign_LoanAmt);
		...
		Thread.sleep(2000);
		String ESign_LoanAmt=driver.findElement(By.xpath("//*[@id='errorMessage']/form[1]/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[7]/td[2]/input")).getAttribute("value");
		test.log(LogStatus.PASS, "LOC amount is : "+ESign_LoanAmt);
		...
		test.log(LogStatus.PASS, "(LOC)Loan amount entered as  "+ESign_LoanAmt);
