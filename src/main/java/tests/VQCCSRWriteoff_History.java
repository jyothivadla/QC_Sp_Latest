...
public class VQCCSRWriteoff_History extends QCStore{
	...
	public static void VQCCSRWriteoff_History(String SSN,String AppURL)
	{
		try{
	...
	//------------------------						
		...
		//Loan Balance Summary
							...
							if(ESign_CollateralType.equals("ACH"))
							{
								...
								if(ach_history_ach_check_acc_no.equalsIgnoreCase(ach_history_ach_check_acc_no))
								{
									test.log(LogStatus.PASS, "ACH_check_acc_no->Expected value:"+ach_history_ach_check_acc_no +"; == Actual value:"+ach_history_ach_check_acc_no);
								}
								else
								{
									test.log(LogStatus.FAIL, "ACH_check_acc_no->Expected value:"+ach_history_ach_check_acc_no +"; not equals to Actual value:"+ach_history_ach_check_acc_no);
